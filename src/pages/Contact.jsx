    ...
    <div className="overflow-hidden">
      ...
      <div className="bg-[#0B132B] text-white py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            आपल्याला कोणत्याही उत्पादनाबद्दल माहिती हवी असल्यास किंवा प्रत्यक्ष भेट द्यायची असल्यास खालील माहितीचा वापर करा.
          </motion.p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="p-10 sm:p-16 flex flex-col justify-center">
              <h2 className="text-4xl font-extrabold font-marathi text-[#0B132B] mb-12">आमचा पत्ता आणि वेळ</h2>
              ...
              <div className="space-y-10 mb-14">
                <div className="flex items-start gap-6 group">
                  <div className="bg-yellow-50 group-hover:bg-[var(--color-brand-yellow)] transition duration-500 p-5 rounded-[1.5rem] shrink-0 mt-1">
                    <MapPin className="text-[var(--color-brand-yellow)] group-hover:text-[#0B132B] transition duration-500" size={32} />
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold font-marathi text-[#0B132B] mb-3">पत्ता (Address)</h3>
                    <p className="text-gray-600 font-marathi text-lg leading-relaxed">
                      श्री शंभो कृषी सेवा केंद्र,<br/>
                ...
                <div className="flex items-start gap-6 group">
                  <div className="bg-green-50 group-hover:bg-[var(--color-brand-green)] transition duration-500 p-5 rounded-[1.5rem] shrink-0 mt-1">
                    <Clock className="text-[var(--color-brand-green)] group-hover:text-white transition duration-500" size={32} />
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold font-marathi text-[#0B132B] mb-3">वेळ (Business Hours)</h3>
                    <p className="text-gray-600 font-marathi text-lg">
                      सोमवार ते रविवार: <br/>
                      सकाळी ०८:०० ते संध्याकाळी ०८:००
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative h-[800px] lg:h-auto flex flex-col bg-gray-100">
               ...
               <div className="h-1/3 w-full relative overflow-hidden group">
                 <img src="/assets/exterior_1.png" alt="Shop Front" className="w-full h-full object-cover group-hover:scale-110 transition duration-1000" loading="lazy" />
                 <div className="absolute inset-0 bg-gradient-to-t from-[#0B132B]/90 to-transparent"></div>
                 <div className="absolute bottom-8 left-8">
                   <h3 className="text-2xl font-bold font-marathi text-white">हे आमचे प्रत्यक्ष दुकान आहे.</h3>
                 </div>
               </div>
            </div>
          </motion.div>
